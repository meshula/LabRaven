 ...
 */
pxr::GfMatrix4d GetTransformMatrix(pxr::UsdGeomXformable geom, pxr::UsdTimeCode timeCode);
 ...
 */
void SetTransformMatrix(pxr::UsdGeomXformable geom, pxr::GfMatrix4d transform, pxr::UsdTimeCode timeCode);
