...
void ImGuiConsole::LogWindow()
{
    ...
    // There appears to be a bug in ImGui???? Where if the child window is shrunk to zero
    // size, EndChild has to be called, even though BeginChild returned false ????
    /// @TODO ask Omar
