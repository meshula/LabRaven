...
struct HydraOutlinerActivity::data {
    data() {
...
void HydraOutlinerActivity::HydraOutlinerUI(const LabViewInteraction& vi) {
}

void HydraOutlinerActivity::RunUI(const LabViewInteraction& vi) {
...
void HydraOutlinerActivity::_activate() {
    if (!gGhost[0].h) {
...
HydraOutlinerActivity::HydraOutlinerActivity()
: Activity(HydraOutlinerActivity::sname()) {
    _self = new HydraOutlinerActivity::data();
    activity.RunUI = [](void* instance, const LabViewInteraction* vi) {
        static_cast<HydraOutlinerActivity*>(instance)->RunUI(*vi);
    };
}
