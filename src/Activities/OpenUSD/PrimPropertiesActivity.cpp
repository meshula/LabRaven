...
struct PrimPropertiesActivity::data {
    data() = default;
    ~data() = default;
...
PrimPropertiesActivity::PrimPropertiesActivity() : Activity(PrimPropertiesActivity::sname()) {
    _self = new PrimPropertiesActivity::data();

    activity.RunUI = [](void* instance, const LabViewInteraction* vi) {
        static_cast<PrimPropertiesActivity*>(instance)->RunUI(*vi);
    };
}

PrimPropertiesActivity::~PrimPropertiesActivity() {
    delete _self;
}

void PrimPropertiesActivity::RunUI(const LabViewInteraction& vi) {
    if (!this->UIVisible()) {
        return;
    }
