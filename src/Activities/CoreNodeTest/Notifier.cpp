...
{
    if (type == Type::SUCCESS) { return (char*) u8"\ue86c"; }
    else if (type == Type::WARNING) { return (char*) u8"\ue002"; }
    else if (type == Type::ERROR) { return (char*) u8"\ue000"; }
    else if (type == Type::INFO) { return (char*) u8"\ue88e"; }
    else { return ""; }
}
